        ...
        static RxApp()
        {
            ...
            DefaultExceptionHandler = Observer.Create<Exception>(ex => {
                ...
                RxApp.MainThreadScheduler.Schedule(() => {
                    throw new Exception(
                        @"An OnError occurred on an object (usually ObservableAsPropertyHelper) 
                        that would break a binding or command. To prevent this,
                        Subscribe to the ThrownExceptions property of your objects",
                        ex);
                });
            });
