...
namespace Perspex.Diagnostics.ViewModels
{
    internal class DevToolsViewModel : ReactiveObject
    {
        ...
        {
            get { return _root; }
            set { this.RaiseAndSetIfChanged(ref _root, value as Control); }
        }
        ...
        public IInputElement FocusedControl { get { return _focusedControl.Value; }}

        public IInputElement PointerOverElement { get { return  _pointerOverElement.Value; }}
    }
}
