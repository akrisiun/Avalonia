...
namespace TheArtOfDev.HtmlRenderer.Core.Dom
{
    ...
    internal class CssBox : CssBoxProperties, IDisposable
    {
        ...
        public bool IsBrElement
        {
            get
            {
                return _htmltag != null && _htmltag.Name.Equals("br",
                      StringComparison.OrdinalIgnoreCase); // .InvariantCultureIgnoreCase); 
            }
        }
        ...
        private void CreateListItemBox(RGraphics g)
        {
            if (Display == CssConstants.ListItem && ListStyleType != CssConstants.None)
            {
                if (_listItemBox == null)
                {
                    ...
                    if (ListStyleType.Equals(CssConstants.Disc, 
                        StringComparison.OrdinalIgnoreCase)) // ..InvariantCultureIgnoreCase))
                    {
                        _listItemBox.Text = new SubString("•");
                    }
                    else if (ListStyleType.Equals(CssConstants.Circle, 
                        StringComparison.OrdinalIgnoreCase)) // ..InvariantCultureIgnoreCase))
                    {
                        _listItemBox.Text = new SubString("o");
                    }
                    else if (ListStyleType.Equals(CssConstants.Square,
                        StringComparison.OrdinalIgnoreCase)) // ..
                    {
                        _listItemBox.Text = new SubString("♠");
                    }
                    else if (ListStyleType.Equals(CssConstants.Decimal,
