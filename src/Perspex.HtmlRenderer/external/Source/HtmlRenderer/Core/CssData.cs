...
// using StringComparer = TheArtOfDev.HtmlRenderer.Platform
...
namespace TheArtOfDev.HtmlRenderer.Core
{
    ...
    public sealed class CssData
    {
        ...
        private readonly Dictionary<string, Dictionary<string, List<CssBlock>>> _mediaBlocks =
            new Dictionary<string, Dictionary<string, List<CssBlock>>>(
                StringComparer.OrdinalIgnoreCase); //  .InvariantCultureIgnoreCase);
        ...
        public void AddCssBlock(string media, CssBlock cssBlock)
        {
            ...
            if (!_mediaBlocks.TryGetValue(media, out mid))
            {
                mid = new Dictionary<string, List<CssBlock>>(
                    StringComparer.OrdinalIgnoreCase); // StringComparer.InvariantCultureIgnoreCase);
