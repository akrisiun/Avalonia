...
namespace TheArtOfDev.HtmlRenderer.Core.Handlers
{
    ...
    internal sealed class FontsHandler
    {
        ...
        /// </summary>
        private readonly Dictionary<string, string> _fontsMapping = new Dictionary<string, string>(
        ...
        /// </summary>
        private readonly Dictionary<string, RFontFamily> _existingFontFamilies = new Dictionary<string, RFontFamily>(
            //StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                    );
        ...
        /// </summary>
        private readonly Dictionary<string, Dictionary<double, Dictionary<RFontStyle, RFont>>> _fontsCache = new Dictionary<string, Dictionary<double, Dictionary<RFontStyle, RFont>>>(
