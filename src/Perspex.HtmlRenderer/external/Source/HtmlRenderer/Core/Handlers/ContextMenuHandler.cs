...
namespace TheArtOfDev.HtmlRenderer.Core.Handlers
{
    ...
    internal sealed class ContextMenuHandler : IDisposable
    {
        ...
        static ContextMenuHandler()
        {
            ...
            else if (CultureInfo.CurrentUICulture.Name.StartsWith("de",
                StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                    ))
            {
            ...
            else if (CultureInfo.CurrentUICulture.Name.StartsWith("it",
                StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                    ))
            {
            ...
            else if (CultureInfo.CurrentUICulture.Name.StartsWith("sv",
                StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                    ))
            {
            ...
            else if (CultureInfo.CurrentUICulture.Name.StartsWith("hu",
                StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                    ))
            {
            ...
            else if (CultureInfo.CurrentUICulture.Name.StartsWith("cs",
                StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                    ))
            {
            ...
            else if (CultureInfo.CurrentUICulture.Name.StartsWith("da",
                StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                    ))
            {
                _selectAll = "Vælg alt";
            ...
            else if (CultureInfo.CurrentUICulture.Name.StartsWith("nl",
                StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                    ))
            {
            ...
            else if (CultureInfo.CurrentUICulture.Name.StartsWith("fi",
                StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                    ))
            {
