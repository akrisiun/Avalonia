...
namespace TheArtOfDev.HtmlRenderer.Core.Utils
{
    ...
    internal static class CommonUtils
    {
        ...
        public static string ConvertToAlphaNumber(int number, string style = CssConstants.UpperAlpha)
        {
            ...
            if (style.Equals(CssConstants.LowerGreek,
                StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                            ))
            {
                return ConvertToGreekNumber(number);
            }
            else if (style.Equals(CssConstants.LowerRoman,
                StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                            ))
            {
                return ConvertToRomanNumbers(number, true);
            }
            else if (style.Equals(CssConstants.UpperRoman,
                StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                            ))
            {
                return ConvertToRomanNumbers(number, false);
            }
            else if (style.Equals(CssConstants.Armenian,
                StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                            ))
            {
                return ConvertToSpecificNumbers(number, _armenianDigitsTable);
            }
            else if (style.Equals(CssConstants.Georgian,
                StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                            ))
            {
                return ConvertToSpecificNumbers(number, _georgianDigitsTable);
            }
            else if (style.Equals(CssConstants.Hebrew,
                StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                            ))
            {
                return ConvertToSpecificNumbers(number, _hebrewDigitsTable);
            }
            else if (style.Equals(CssConstants.Hiragana,
                StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                            ) || style.Equals(CssConstants.HiraganaIroha,
                            StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                            ))
            {
                return ConvertToSpecificNumbers2(number, _hiraganaDigitsTable);
            }
            else if (style.Equals(CssConstants.Katakana,
                StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                            ) || style.Equals(CssConstants.KatakanaIroha,
                            StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                            ))
            {
            ...
            {
                var lowercase = style.Equals(CssConstants.LowerAlpha,
                    StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                            ) || style.Equals(CssConstants.LowerLatin,
                            StringComparison.OrdinalIgnoreCase // StringComparison.InvariantCultureIgnoreCase
                            );
        ...
        private static string ConvertToSpecificNumbers(int number, string[,] alphabet)
        {
            ...
            while (number > 0 && level < alphabet.GetLength(0))
            {
                var n = number % 10;
                if (n > 0)
                    sb = alphabet[level, number % 10 - 1].ToString() 
