...
namespace Perspex.Themes.Default
{
    ...
    public class WindowStyle : Styles
    {
        ...
        public void AddRange<TWindow>() where TWindow : ContentControl // IStyleable
        { 
            AddRange(new[]
            {
                new Style(x => x.OfType<TWindow>())
                {
                    Setters = new[]
                    {
                        new Setter(TemplatedControl.TemplateProperty, new ControlTemplate<TWindow>(Template)),
