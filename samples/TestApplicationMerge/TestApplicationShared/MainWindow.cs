...
namespace TestApplication
{
    class MainWindow
    {
        ...
        public static Window Create()
        {
            ...
            window.Content = (container = new TabControl
            {
        ...
        private static TabItem ImagesTab()
        {
            ...
            StreamGeometry svgData = null;
            try
            {
                svgData = StreamGeometry.Parse("M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z");
            }
            catch (Exception) { }
            ...
            string str = "M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z";

            Program.builder.UseRenderingSubsystem("Avalonia.Direct2D1");
            IPlatformRenderInterface factory = AvaloniaLocator.Current.GetService<IPlatformRenderInterface>();
            var PlatformImpl = factory?.CreateStreamGeometry();

            StreamGeometry svgData2 = null;

            StreamGeometry result = factory == null ? null : new StreamGeometry();
            if (result != null)
            ...
            var prev = new Button
            {
                ...
                Content = new Avalonia.Controls.Shapes.Path
                {
                    Data = svgData2, // StreamGeometry.Parse("M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z"),
                    Fill = Brushes.Black
                }
            };
